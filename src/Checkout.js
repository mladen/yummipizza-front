...
export default function Checkout() {
  ...
  return (
    <React.Fragment>
      ...
      <FormControl fullWidth className={classes.margin} variant="filled">
        <InputLabel htmlFor="filled-adornment-deliveryaddress">
          Delivery address:
        </InputLabel>
        <FilledInput
      ...
      <FormControl fullWidth className={classes.margin} variant="filled">
        <InputLabel htmlFor="filled-adornment-contactphonenumber">
      ...
      >
        ...
        <FilledInput
          ...
          value={
            total > 0 && total <= 5
              ? currency === "usd"
                ? ((total + DELIVERY_COST) * USD_RATE).toFixed(2)
                : (total + DELIVERY_COST).toFixed(2)
              : currency === "usd"
